                                  ...
                                  UITableViewDataSource
{
  ...
  override func viewWillAppear(_ animated: Bool) {
    ...
    // In a SwiftUI-based app, UIViewController's navigationItem doesn't get set. Get the navigation
    // item from the navigationController directly instead. This must be done in `viewWillAppear:`
    // or later.
    guard let navigationItem = navigationController?.navigationBar.topItem else { return }
